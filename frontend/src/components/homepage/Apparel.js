...
const Apparel = ({Aposts}) => {
    ...
    return (
       ...
       {Aposts.filter((Apparel)=>{
           if(serachItem==""){
             return Apparel
           }else if(Apparel.Apparel_Name.toLowerCase().includes(serachItem.toLowerCase())){
             return Apparel
           }
         })
       ...
       <div className="card p-0 overflow-hidden h-100 shadow" >
         ...
         <h4 className="card-title">&nbsp; {Apparel.Apparel_Name} </h4>
         <p className="card-text">&nbsp; Unit price: {Apparel.Price}</p>
         <p className="card-text">&nbsp;category: {Apparel.shippingCost}</p>
