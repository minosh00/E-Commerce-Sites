...
{Hposts.filter((Homeimprovement)=>{
    if(serachItem==""){
      return Homeimprovement
    }else if(Homeimprovement.Homeimprovement_Name.toLowerCase().includes(serachItem.toLowerCase())){
      return Homeimprovement
    }
  })
 
      .map((Homeimprovement, key) =>(
...
<div className="card p-0 overflow-hidden h-100 shadow" >
  ...
  <h4 className="card-title">&nbsp; {Homeimprovement.Homeimprovement_Name} </h4>
  <p className="card-title">&nbsp;Brand Name: {Homeimprovement.Homeimprovement_category} </p>
  <p className="card-text">&nbsp; Unit price: {Homeimprovement.funitPrice}</p>
  <p className="card-text">&nbsp;category: {Homeimprovement.shippingCost}</p>
  <p className="card-text">&nbsp;Shipping cost: {Homeimprovement.quntityAvailable}</p>
